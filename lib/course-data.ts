...
export const course = {
  ...
  program: 'Independent machine-learning curriculum',
  school: 'Open learning studio',
  semester: 'V',
  credits: 4,
  ltp: '2:0:4',
  durationWeeks: 15,
  ...
  instructor: 'Independent course team',
  description:
...
export const materials: Material[] = [
  {
    id: 'experiment-protocol-v1',
    title: 'Machine-Learning Experiment Protocol',
    description:
      'A compact protocol for hypotheses, temporal/data splits, baselines, leakage controls, metrics, uncertainty, and reproducibility.',
    kind: 'reference',
    href: '/materials/EXPERIMENT_PROTOCOL.md',
  ...
  {
    id: 'model-evaluation-checklist-v1',
    title: 'Model-Evaluation Checklist',
    description:
      'A decision-focused checklist for baselines, threshold metrics, calibration, pipeline fitting, uncertainty, and failure inspection.',
    kind: 'reference',
    href: '/materials/MODEL_EVALUATION_CHECKLIST.md',
    fileName: 'MODEL_EVALUATION_CHECKLIST.md',
    format: 'Markdown',
    sizeLabel: '< 2 KB',
    status: 'published',
    publishedAt: '2026-09-03',
...
export const assessmentReviewFlag = {
  ...
  detail:
    'Assessment weights are intentionally absent from the public reference release; an adopting course owner must supply and review its own policy.',
};
