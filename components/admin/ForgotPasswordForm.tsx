    ...
    <>
      <form className="login-form" onSubmit={submit}>
        <label>
          ...
          <input type="email" name="email" autoComplete="email" required value={email} onChange={(event) => setEmail(event.target.value)} placeholder="instructor@vidyashilp.edu.in" />
        </label>
