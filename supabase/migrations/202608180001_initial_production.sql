...
-- publishing view, and official DATA301 course/session seed.
...
begin
  if not exists (
    ...
    alter table public.materials
      add constraint materials_visibility_check check (visibility in ('public', 'staff'));
  end if;
end $$;
...
-- update public.profiles set role = 'admin', display_name = 'Dr. Shabbeer Basha'
