...
export default function OverfittingPage() {
  return (
    <main id="main-content" className="lab-page">
      <section className="lab-page-hero lab-page-hero--amber"><div className="shell"><Link className="back-link" href="/labs">← Interactive labs</Link><span className="eyebrow">Modules 2 & 4 · Generalization</span><h1>Overfitting & Generalization Lab</h1><p>Watch training error fall as complexity rises—then see why unseen-data error is the result that matters.</p></div></section>
