...
export default function ProjectsPage() {
  return (
    <main id="main-content">
      ...
      <section className="section section--ink"><div className="shell project-requirements"><div><span className="eyebrow eyebrow--light">Research project expectations</span><h2>A complete submission is more than a model score.</h2><p className="section-lead section-lead--light">A defensible project begins with a precise scope and baseline, then retains implementation, evaluation, limitations, source code, and a reproducible report.</p></div><div className="requirement-list"><div><span>01</span><p>Define title, inputs, outputs, dataset, and scope.</p></div><div><span>02</span><p>Conduct literature survey and establish a model baseline.</p></div><div><span>03</span><p>Present preliminary results and a credible further plan.</p></div><div><span>04</span><p>Submit report, presentation, source code, and README.</p></div><div><span>05</span><p>Demonstrate code and defend decisions through viva.</p></div></div></div></section>
    </main>
  );
}
