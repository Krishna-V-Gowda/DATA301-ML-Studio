...
export default function ProjectsPage() {
  return (
    <main id="main-content" className="v51-route v51-route--projects">
      ...
      <section className="v51-project-context">
        <div className="shell v51-project-context__grid">
          <figure className="v51-project-context__image">
            <Image
              src="/campus/vu-campus-building.webp"
          ...
          <div className="v51-project-context__copy">
            <span className="eyebrow">Applied at Vidyashilp</span>
            <h2>Move from a model that runs to an argument you can defend.</h2>
            <p>
              Project work turns course concepts into evidence: a clear
              question, responsible data preparation, an appropriate baseline,
              measurable evaluation, honest limitations, and reproducible
              implementation.
            </p>

            <div className="v51-project-context__sequence"
              aria-label="Project workflow">
              <span>Question</span><i>→</i>
              <span>Evidence</span><i>→</i>
              <span>Iteration</span><i>→</i>
              <span>Defence</span>
            </div>
          </div>
        </div>
